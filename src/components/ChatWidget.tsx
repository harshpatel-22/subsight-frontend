		...
		<>
			...
			{open && (
				<motion.div
					...
					className='fixed bottom-20 right-6 z-50 w-[350px] sm:w-[400px] bg-white border border-gray-200 shadow-2xl rounded-xl flex flex-col max-h-[80vh]'
				>
					{/* Header */}
					...
					<div className='flex-1 overflow-y-auto p-4 space-y-3 text-sm'>
						{messages.map((msg, i) => (
							<div
								key={i}
                                className={`p-3 rounded-lg max-w-[85%] ${msg.sender === 'user'? 'bg-blue-100 ml-auto text-gray-800'
